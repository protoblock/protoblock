...
class JsonPath {
public:
    explicit JsonPath( QJsonValue &jsonVal )
    {
        ...
        else
        {
            ...
            {
                qDebug() << "object is empty and so is array. ";
            }
        }
    }

    explicit JsonPath( QJsonObject &jsonObj )
    {
        initWithNode( jsonObj );
    }

    explicit JsonPath( QJsonArray &jsonArray )
    {
        initWithNode( jsonArray );
    }

    explicit JsonPath( QJsonDocument &jsonDoc )
    {
