...
class FantasyNameHash : public ::google_public::protobuf::Message {
 public:
  FantasyNameHash();
  ...
  inline ::google_public::protobuf::uint64 hash() const;
  inline void set_hash(::google_public::protobuf::uint64 value);
 ...
 private:
  ...
  ::std::string* name_;
  ::google_public::protobuf::uint64 hash_;
...
class Distribution : public ::google_public::protobuf::Message {
 public:
  Distribution();
  ...
  inline ::google_public::protobuf::int32 season() const;
  inline void set_season(::google_public::protobuf::int32 value);
  ...
  inline ::google_public::protobuf::uint64 fantasy_nameid() const;
  inline void set_fantasy_nameid(::google_public::protobuf::uint64 value);
 ...
 private:
  ...
  ::std::string* gameid_;
  ::std::string* teamid_;
  ::google_public::protobuf::int32 season_;
  ::google_public::protobuf::int32 week_;
  ::google_public::protobuf::uint64 fantasy_nameid_;
...
class ProjKstats : public ::google_public::protobuf::Message {
 public:
  ProjKstats();
  virtual ~ProjKstats();
...
class ProjDstats : public ::google_public::protobuf::Message {
 public:
  ProjDstats();
  virtual ~ProjDstats();
...
class ProjOstats : public ::google_public::protobuf::Message {
 public:
  ProjOstats();
  virtual ~ProjOstats();
...
class ProjStats : public ::google_public::protobuf::Message {
 public:
  ProjStats();
  virtual ~ProjStats();
...
inline ::google_public::protobuf::uint64 FantasyNameHash::hash() const {
  return hash_;
}
inline void FantasyNameHash::set_hash(::google_public::protobuf::uint64 value) {
  set_has_hash();
  hash_ = value;
}
...
inline ::google_public::protobuf::int32 Distribution::season() const {
  return season_;
}
inline void Distribution::set_season(::google_public::protobuf::int32 value) {
  set_has_season();
  season_ = value;
}
...
inline ::google_public::protobuf::int32 Distribution::week() const {
  return week_;
}
inline void Distribution::set_week(::google_public::protobuf::int32 value) {
  set_has_week();
  week_ = value;
}
...
inline ::google_public::protobuf::uint64 Distribution::fantasy_nameid() const {
  return fantasy_nameid_;
}
inline void Distribution::set_fantasy_nameid(::google_public::protobuf::uint64 value) {
...
inline ::google_public::protobuf::int32 Distribution::proj() const {
  return proj_;
}
inline void Distribution::set_proj(::google_public::protobuf::int32 value) {
  set_has_proj();
  proj_ = value;
}
