...
inline bool PlayerStatus_Status_Parse(
  ...
  return ::google_public::protobuf::internal::ParseNamedEnum<PlayerStatus_Status>(
...
inline bool GameStatus_Status_Parse(
  ...
  return ::google_public::protobuf::internal::ParseNamedEnum<GameStatus_Status>(
...
inline bool GlobalState_State_Parse(
  ...
  return ::google_public::protobuf::internal::ParseNamedEnum<GlobalState_State>(
...
inline bool PlayerGameStatus_Parse(
  ...
  return ::google_public::protobuf::internal::ParseNamedEnum<PlayerGameStatus>(
    PlayerGameStatus_descriptor(), name, value);
}
// ===================================================================

class PlayerStatus : public ::google_public::protobuf::Message {
 public:
  PlayerStatus();
...
class GameStatus : public ::google_public::protobuf::Message {
 public:
  GameStatus();
  virtual ~GameStatus();
  ...
  inline ::google_public::protobuf::uint32 datetime() const;
  inline void set_datetime(::google_public::protobuf::uint32 value);
 ...
 private:
  ...
  mutable int _cached_size_;
  int status_;
  ::google_public::protobuf::uint32 datetime_;
  friend void  protobuf_AddDesc_StatusData_2eproto();
  friend void protobuf_AssignDesc_StatusData_2eproto();
  friend void protobuf_ShutdownFile_StatusData_2eproto();
...
class TeamDepth : public ::google_public::protobuf::Message {
 public:
  TeamDepth();
  virtual ~TeamDepth();
  ...
  inline const ::google_public::protobuf::RepeatedPtrField< ::std::string>& qb() const;
  inline ::google_public::protobuf::RepeatedPtrField< ::std::string>* mutable_qb();
  ...
  inline const ::google_public::protobuf::RepeatedPtrField< ::std::string>& rb() const;
  inline ::google_public::protobuf::RepeatedPtrField< ::std::string>* mutable_rb();
  ...
  inline const ::google_public::protobuf::RepeatedPtrField< ::std::string>& wr() const;
  inline ::google_public::protobuf::RepeatedPtrField< ::std::string>* mutable_wr();
  ...
  inline const ::google_public::protobuf::RepeatedPtrField< ::std::string>& te() const;
  inline ::google_public::protobuf::RepeatedPtrField< ::std::string>* mutable_te();
  ...
  inline const ::google_public::protobuf::RepeatedPtrField< ::std::string>& k() const;
  inline ::google_public::protobuf::RepeatedPtrField< ::std::string>* mutable_k();
 ...
 private:
  ...
  ::google_public::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google_public::protobuf::RepeatedPtrField< ::std::string> qb_;
  ::google_public::protobuf::RepeatedPtrField< ::std::string> rb_;
  ::google_public::protobuf::RepeatedPtrField< ::std::string> wr_;
  ::google_public::protobuf::RepeatedPtrField< ::std::string> te_;
  ::google_public::protobuf::RepeatedPtrField< ::std::string> k_;
  friend void  protobuf_AddDesc_StatusData_2eproto();
  friend void protobuf_AssignDesc_StatusData_2eproto();
  friend void protobuf_ShutdownFile_StatusData_2eproto();
...
class GlobalState : public ::google_public::protobuf::Message {
 public:
  GlobalState();
  virtual ~GlobalState();
...
inline ::google_public::protobuf::uint32 GameStatus::datetime() const {
  // @@protoc_insertion_point(field_get:fantasybit.GameStatus.datetime)
  return datetime_;
}
inline void GameStatus::set_datetime(::google_public::protobuf::uint32 value) {
  set_has_datetime();
  datetime_ = value;
...
inline ::google_public::protobuf::uint32 GlobalState::season() const {
  // @@protoc_insertion_point(field_get:fantasybit.GlobalState.season)
  return season_;
}
inline void GlobalState::set_season(::google_public::protobuf::uint32 value) {
  set_has_season();
  season_ = value;
...
inline ::google_public::protobuf::uint32 GlobalState::week() const {
  // @@protoc_insertion_point(field_get:fantasybit.GlobalState.week)
  return week_;
}
inline void GlobalState::set_week(::google_public::protobuf::uint32 value) {
  set_has_week();
  week_ = value;
...
template <> struct is_proto_enum< ::fantasybit::PlayerStatus_Status> : ::google_public::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::fantasybit::GameStatus_Status> : ::google_public::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::fantasybit::GameStatus_Status>() {
  return ::fantasybit::GameStatus_Status_descriptor();
}
template <> struct is_proto_enum< ::fantasybit::GlobalState_State> : ::google_public::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::fantasybit::GlobalState_State>() {
  return ::fantasybit::GlobalState_State_descriptor();
}
template <> struct is_proto_enum< ::fantasybit::PlayerGameStatus> : ::google_public::protobuf::internal::true_type {};
template <>
