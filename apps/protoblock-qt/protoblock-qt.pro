...
#INCLUDEPATH += $$PWD/../../../prebuiltLibs/windo   ws/3rdParty/secp256k1
...
CONFIG(debug,debug|release) { message("pbt0 Debug mode") }
else { message("pbt0 Release mode") }

message(pqt $$CONFIG )

HEADERS += \
    $$PWD/src/domainstatic.h
