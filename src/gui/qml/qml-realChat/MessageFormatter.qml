...
QtObject {
    ...
    property IrcTextFormat textFormat: IrcTextFormat {
        ...
        palette.gray: Colors.grey
        palette.lightGray: "#333333"

        // http://ethanschoonover.com/solarized
        palette.blue: Colors.blue
        palette.green: Colors.green
        palette.red: Colors.red
        palette.brown: Colors.brown
        palette.purple: Colors.purple
        palette.orange: Colors.orange
        palette.yellow: Colors.yellow
        palette.lightGreen: Colors.lightGreen
        palette.cyan: Colors.cyan
        palette.lightCyan: "#2aa198"
        palette.lightBlue: Colors.lightBlue
        palette.pink: Colors.pink
    }
