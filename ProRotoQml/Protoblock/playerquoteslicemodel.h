...
class PlayerQuoteSliceModelItem : public QObject {
    ...
    QML_READONLY_CSTREF_PROPERTY (qint32, myposition)
    QML_READONLY_CSTREF_PROPERTY (qint32, mypnl)
    QML_READONLY_CSTREF_PROPERTY (double, myavg)
    QML_READONLY_CSTREF_PROPERTY (double, ytd)
